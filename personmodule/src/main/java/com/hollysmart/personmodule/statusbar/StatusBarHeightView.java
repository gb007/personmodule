package com.hollysmart.personmodule.statusbar;
...
public class StatusBarHeightView extends LinearLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.PersonModuleStatusBarHeightView);
            type = typedArray.getInt(R.styleable.PersonModuleStatusBarHeightView_person_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
